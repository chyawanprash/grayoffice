...
/**
 * Pixel-grid loader for long-running agent work. Ported from
 * context/ai-features/chat-states.md (Drive / Dots / Orbit variants), paired
 * with a shimmering label and a live elapsed timer.
 */
